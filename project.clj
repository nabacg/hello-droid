(defproject hello-droid/hello-droid "0.0.1-SNAPSHOT"
             ...
             [:android-common :android-user
              {:dependencies [[org.clojure-android/tools.nrepl "0.2.6-lollipop"]]
               ...
               :android {:aot :all-with-unused
                         :rename-manifest-package "com.droid.clj.debug"
                         :manifest-options {:app-name "HelloDroid - debug"}}}]
             :release
             [:android-common
  ...
  :android {;; Specify the path to the Android SDK directory.
            ...
            :sdk-path "/usr/local/Cellar/android-sdk/24.0.2"})
