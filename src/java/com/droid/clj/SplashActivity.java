...
public class SplashActivity extends Activity {
    ...
    public void proceed() {
        startActivity(new Intent("com.droid.clj.MAIN"));
        finish();
    }
    ...
    public void loadClojure() {
        new Thread(new Runnable(){
                ...
                public void run() {
                    ...
                    try {
                        Class.forName("com.droid.clj.StartActivity");
                    } catch (ClassNotFoundException e) {
                        Log.e(TAG, "Failed loading StartActivity", e);
                    }
